...
public class CourseStudentAdapter extends ArrayAdapter {

    ArrayList<Students> students;
    Context context;

    public CourseStudentAdapter(Context context, ArrayList<Students> students) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        TextView name =convertView.findViewById(R.id.course_student_item_name);
        TextView id = convertView.findViewById(R.id.course_student_item_id);
